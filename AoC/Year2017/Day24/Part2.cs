    ...
    public class Part2 : BasePart
    {
        ...
        public class BridgeNode : Node<BridgeNode>
        {
            ...
            public override decimal CurrentCost => 
                (StaticInfo.Pieces.Length - UsedPieces.Length) * StaticInfo.MaxStrength +
                StaticInfo.MaxStrength - Strength;
            public decimal Strength => UsedPieces.Select(i => StaticInfo.Pieces[i]).Sum(i => i.Sum());
        ...
        protected void RunScenario(string title, string input)
        {
            RunScenario(title, () =>
            {
                ...
                Console.WriteLine(best.Strength);
            });
        }
