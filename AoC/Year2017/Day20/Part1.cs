    ...
    public class Part1 : BasePart
    {
        protected void RunScenario(string title, string input)
        {
            RunScenario(title, () =>
            {
                ...
                var minA = ps.OrderBy(i => i.Acceleration.Distance).ThenBy(i => i.Velocity.Distance).ThenBy(i => i.Position.Distance).First();
                Console.WriteLine(minA.id);
            });
        }

        public override void Run()
        {
            RunScenario("initial", @"p=< 3,0,0>, v=< 2,0,0>, a=<-1,0,0>
